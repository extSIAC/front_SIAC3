                ...
                <div class="content" style="margin-left: 0px; margin-right: 0px;padding-left: 0px;padding-right: 0px; background-color: #ffffff;">
                    <div class="block">
                                ...
                                <div class="col-sm-12 nice-copy text-center">
                                    <br><br>
                                <h5 style="font-size: 1.5vw">DEPARTAMENTO DE ACTIVIDADES EXTRAESCOLARES</h5>
                                <h4 style=" font-size: 1.2vw; color: rgb(21, 139, 182);">INSCRIPCIÓN A ACTIVIDAD EXTRAESCOLAR <br> PERIODO ENERO - JUNIO 2022</h4>
